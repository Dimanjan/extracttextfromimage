#!/usr/bin/env python3
"""
Test API Layer OCR API with text-containing image URL
"""
...
def main():
    """Main test function"""
    print("🧪 Testing API Layer OCR API with text-containing images")
    print("=" * 60)
    
    # API key
    api_key = "Gr2DJAt4f6lGFNJHMvpFeOCE4nCHh4hB"
    
    # Test with images that contain text
    test_urls = [
        # Simple text image
        "https://via.placeholder.com/600x200/FFFFFF/000000?text=Hello+World+OCR+Test",
        # More complex text
        "https://via.placeholder.com/800x400/FFFFFF/000000?text=This+is+a+test+image+with+multiple+lines+of+text+for+OCR+testing",
        # Different colors
        "https://via.placeholder.com/600x300/000000/FFFFFF?text=Black+background+white+text+OCR+test",
        # URL with text
        "https://httpbin.org/image/jpeg"
    ]
    
    print("🖼️  Testing with text-containing URLs:")
    print()
